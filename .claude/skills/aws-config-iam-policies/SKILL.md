...
description: >
  ...
  inside `infra/aws/tf/config/aws/config.json` for the Customer 360 / NorthBridge
...
This skill governs the `aws.iam` block in `infra/aws/tf/config/aws/config.json`.
